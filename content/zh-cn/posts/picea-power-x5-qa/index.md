...
> 6016版本的主要变动包括：
>
> 1. **新增自定义关机时长**：这一功能旨在避免因关机过早而导致某些设备在停止取电后再取电时无法正常工作，例如iOS的计划充电功能，以及一些超低功率的设备。
>
> 2. **协议芯片固件更新**：针对第三批公测发货的产品，协议芯片的固件进行了更新，主要优化了C2口的稳定性，并解决了一部分PD3.1充电器的兼容性问题。
>
> 这些更新旨在提升产品的性能和用户体验，确保设备在各种使用场景下都能稳定可靠地工作。

### 怎么升级X5的固件？

> 要升级X5的固件，需要使用一个蓝牙模块。在DC口旁边预留了一个串口用于与主控通信。未来可能会开源这个模块，但目前需要联系客服获取。
>
> 需要注意的是，目前只能更新主控部分的固件，协议芯片的固件暂时无法通过这种方式更新，这需要将充电宝发回工厂进行更新。
>
> 因此，如果您需要升级固件，请先确认需要更新的部分，并根据情况选择合适的方式进行升级。
